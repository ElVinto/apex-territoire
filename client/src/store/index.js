...
export default new Vuex.Store({
   ...
   getters: { // computed methods
      ...
      getSelectedWeekMetricTotalNbObs: (state,getters) =>{
         ...
         let selected_week_metric = getters.getSelectedWeekMetric;
         let nbObsFullGrowth = parseInt(selected_week_metric.nbObsFullGrowth);
         let nbObsSlowGrowth = parseInt(selected_week_metric.nbObsSlowGrowth);
         let nbObsStoppedGrowth = parseInt(selected_week_metric.nbObsStoppedGrowth);
   ...
   mutations: { // synchronous  commit of changes of state
      ...
      saveSelectedWeekMetric(state, week_metric){
         ...
         // local recording
         state.userModifiedWeekMetrics.set(`pIdx:${state.selectedParcelIdx} yIdx:${state.selectedYearIdx} wIdx:${state.selectedYearIdx}`, week_metric)
      ...
      deleteSelectedWeekMetric(state, week_metric){
         ...
         // this.$store.commit("deleteSelectedWeekMetric", this.$store.getSelectedWeekMetric)

         if(week_metric.modified ){
            
            state.userModifiedWeekMetrics.delete(`pIdx:${state.selectedParcelIdx} yIdx:${state.selectedYearIdx} wIdx:${state.selectedYearIdx}`, week_metric)
            ...
            console.log("only modified week metrics need to be deleted ");
         }
